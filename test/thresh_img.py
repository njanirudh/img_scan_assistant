...
#     cv2.imwrite("/home/anirudh/NJ/Github/img_scan_assistant/imge_test/"+str(count)+".jpg",pic)

# cv2.imshow("1", photo_list.pop(2))
cv2.imshow("2", full_img)
cv2.imwrite("/home/anirudh/NJ/Github/img_scan_assistant/imge_test/"+"full"+".jpg",full_img)
